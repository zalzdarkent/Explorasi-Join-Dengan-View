        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($password, $user['password'])) {
                if (isset($_POST['remember_me']) && $_POST['remember_me'] == 'on') {
                    ...
                    $update_token_query = "UPDATE users SET remember_token = '$remember_token' WHERE email='$email'";
                    $conn->query($update_token_query);
                    setcookie('remember_me_cookie', $remember_token, time() + (86400 * 30), "/");
                }
                session_start();
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Z'Laundry! 👋</h4>
